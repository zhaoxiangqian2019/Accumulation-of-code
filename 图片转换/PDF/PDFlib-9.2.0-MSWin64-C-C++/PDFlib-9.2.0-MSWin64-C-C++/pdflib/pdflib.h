...
#define PDFLIB_MINORVERSION	2       	/* minor version number */
#define PDFLIB_REVISION		0       	/* revision number */
#define PDFLIB_SHORT_VERSIONSTRING "9"          /* short version number */
#define PDFLIB_LONG_VERSIONSTRING  "9.2.0" /* full version number*/
 ...
 */
    ...
    #if _LARGE_FILES==1 || defined(_LARGEFILE_SOURCE) || _FILE_OFFSET_BITS==64
    #include <sys/types.h>
