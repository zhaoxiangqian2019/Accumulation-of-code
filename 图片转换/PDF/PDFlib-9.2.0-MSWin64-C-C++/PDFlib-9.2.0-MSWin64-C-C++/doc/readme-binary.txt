...
- 32-bit Windows DLL for C/C++
  The DLL pdflib.dll is supplied along with the corresponding import
  library pdflib.lib. In order to build and run the supplied C/C++ samples
...
The Windows binaries are not compatible with Borland C++ Builder and its
successors. A separate binary package is available for these compilers.
